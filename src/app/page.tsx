...
/** The decorative ambient glows every section sits on. Purely decorative. */
function Ambient({ variant = 0 }: { variant?: 0 | 1 | 2 }) {
  const spots = [
    <>
      <div className="pointer-events-none absolute -top-40 left-[8%] size-[36rem] bg-(image:--glow-iris)" />
      <div className="pointer-events-none absolute top-1/3 -right-40 size-[30rem] bg-(image:--glow-peach)" />
    </>,
    <>
      <div className="pointer-events-none absolute -top-32 right-[12%] size-[32rem] bg-(image:--glow-lilac)" />
      <div className="pointer-events-none absolute bottom-0 -left-40 size-[30rem] bg-(image:--glow-sky)" />
    </>,
    <>
      <div className="pointer-events-none absolute top-10 left-1/4 size-[30rem] bg-(image:--glow-sky)" />
      <div className="pointer-events-none absolute -bottom-32 right-[6%] size-[34rem] bg-(image:--glow-iris)" />
    </>,
  ] as const;
  return (
    ...
    <div className="min-h-dvh overflow-x-clip bg-canvas">
      ...
      <header className="mx-auto flex w-full max-w-6xl items-center justify-between px-5 py-5">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link
            href="/onboarding"
            className="flex items-center gap-2 rounded-2xl bg-iris px-4 py-2.5 text-sm font-semibold text-ink-inverse shadow-card transition-all hover:scale-[1.02] hover:bg-iris-deep"
          >
            Get started
            <ArrowRight size={16} />
          </Link>
      ...
      <main>
      {/* hero */}
      <section className="relative mx-auto grid w-full max-w-6xl items-center gap-12 px-5 py-14 md:grid-cols-2 md:py-24">
        <Ambient variant={0} />
        <Reveal>
          <p className="inline-flex items-center gap-2 rounded-full border border-border bg-surface px-3.5 py-1.5 text-[13px] font-bold text-iris-deep shadow-card dark:text-iris">
            <span className="size-1.5 rounded-full bg-now" aria-hidden />
        ...
        <Reveal delay={120} className="relative mx-auto w-full max-w-sm">
          {/* halo rings — the brand's circle motif, echoing the ◔ mark */}
          <div
            aria-hidden
            className="absolute -inset-10 -z-10 grid place-items-center"
          >
            <div className="absolute size-[26rem] rounded-full border border-iris/15" />
            <div className="absolute size-[32rem] rounded-full border border-iris/10" />
      ...
      <section className="relative border-y border-border bg-surface">
        ...
        <div className="mx-auto w-full max-w-6xl px-5 py-20">
          ...
          <div className="mt-12 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            {[
              <article key="time" className="h-full rounded-3xl border border-border bg-canvas p-6 shadow-card transition-all hover:-translate-y-1 hover:shadow-float">
              ...
              <article key="paralysis" className="h-full rounded-3xl border border-border bg-canvas p-6 shadow-card transition-all hover:-translate-y-1 hover:shadow-float">
                <p className="text-[12px] font-bold uppercase tracking-wide text-ink-faint">
                  Task paralysis
                </p>
                <h3 className="mt-1.5 font-display text-lg font-bold">
              ...
              <article key="hyperfocus" className="h-full rounded-3xl border border-border bg-canvas p-6 shadow-card transition-all hover:-translate-y-1 hover:shadow-float">
                <p className="text-[12px] font-bold uppercase tracking-wide text-ink-faint">
                  Hyperfocus
                </p>
                <h3 className="mt-1.5 font-display text-lg font-bold">
              ...
              <article key="memory" className="h-full rounded-3xl border border-border bg-canvas p-6 shadow-card transition-all hover:-translate-y-1 hover:shadow-float">
                <p className="text-[12px] font-bold uppercase tracking-wide text-ink-faint">
                  Working memory
                </p>
                <h3 className="mt-1.5 font-display text-lg font-bold">
              ...
              <article key="overwhelm" className="h-full rounded-3xl border border-border bg-canvas p-6 shadow-card transition-all hover:-translate-y-1 hover:shadow-float">
                <p className="text-[12px] font-bold uppercase tracking-wide text-ink-faint">
                  Overwhelm
                </p>
                <h3 className="mt-1.5 font-display text-lg font-bold">
              ...
              <article key="shame" className="h-full rounded-3xl border border-border bg-canvas p-6 shadow-card transition-all hover:-translate-y-1 hover:shadow-float">
                <p className="text-[12px] font-bold uppercase tracking-wide text-ink-faint">
                  Shame spirals
                </p>
                <h3 className="mt-1.5 font-display text-lg font-bold">
      ...
      <section className="relative mx-auto w-full max-w-6xl px-5 pb-4 pt-20">
        <Ambient variant={2} />
        <Reveal>
          <p className="text-[13px] font-bold uppercase tracking-[0.14em] text-iris">
        ...
        <div className="mt-12 grid gap-4 lg:grid-cols-3">
          {/* Reward Garden */}
          <Reveal delay={0}>
          <article className="relative h-full overflow-hidden rounded-3xl border border-border bg-surface p-6 shadow-card transition-all hover:-translate-y-1 hover:shadow-float">
            <div
              aria-hidden
          ...
          {/* Focus rituals */}
          <Reveal delay={90}>
          <article className="h-full rounded-3xl border border-border bg-surface p-6 shadow-card transition-all hover:-translate-y-1 hover:shadow-float">
            <p className="text-[12px] font-bold uppercase tracking-wide text-ink-faint">
              Focus rituals
            </p>
            <h3 className="mt-1.5 font-display text-lg font-bold">
      ...
      {/* features */}
      <section className="relative mx-auto w-full max-w-6xl px-5 pb-24 pt-20">
        <Ambient variant={0} />
        <Reveal>
        ...
        <div className="mx-auto w-full max-w-6xl px-5 py-20 text-center">
          <Reveal>
            ...
            <p className="mx-auto mt-4 max-w-md text-[15px] leading-relaxed text-ink-soft">
              Free to start. Kind by design. Made for the brain you actually have.
            </p>
            <Link
              href="/onboarding"
              className="mt-8 inline-flex items-center gap-2 rounded-2xl bg-iris px-7 py-3.5 text-base font-semibold text-ink-inverse shadow-float transition-all hover:scale-[1.03] hover:bg-iris-deep"
            >
              Get started free
              <ArrowRight size={18} />
            </Link>
